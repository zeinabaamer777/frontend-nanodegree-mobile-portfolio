...
var resizePizzas = function (size) {
  ...
  var pizzaText = document.querySelector("#pizzaSize");

  function changeSliderLabel(size) {
    switch (size) {
      case "1":
        pizzaText.innerHTML = "Small";
        return;
      case "2":
        pizzaText.innerHTML = "Medium";
        return;
      case "3":
        pizzaText.innerHTML = "Large";
        return;
      default:
...
function updatePositions() {
  ...
  for (var i = 0; i < itemsLength; i++) {
    phase = Math.sin(bodyScrollTopCalc + (i % 5));
